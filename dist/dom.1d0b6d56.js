...
window.dom = {
  create: function create(string) {
    var container = document.createElement("template"); //template 是可以容纳任意元素的。

    container.innerHTML = string.trim(); //trim是为了把两边的空格去掉

    return container.content.firstChild;
  },
  //在节点后边插入一个节点
  after: function after(node, node2) {
    node.parentNode.insertBefore(node2, node.nextSibling); //找到这个节点的爸爸，在这个爸爸之前插入一个节点
  },
  //在节点前边插入一个节点
...
},{}]},{},["C:/Users/19858/AppData/Local/Yarn/Data/global/node_modules/parcel/src/builtins/hmr-runtime.js","dom.js"], null)
